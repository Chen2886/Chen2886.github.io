      ...
      <Grid className='about-grid' container justify='center' alignItems='center' spacing={3}>
        ...
        <Grid item md={12} lg={6}>
          <p>
            ...
            especially interested in web and iOS development and would love to work for a Formula 1 team or a car manufacturer one day. My passion for
            CS comes from its versatility and because it provides the opportunity to create platforms to help others and make an impact on the world.
            I also enjoy the problem-solving aspect of programming and the ability to express my creativity. Here are some fun facts about me:
          </p>
          <StyledUl>
            <li>In my downtime, I like to organize hackathons, play Cities: Skylines, Apex Legends and make tiramisu!</li>
            ...
            <li>During the summer of 2019, I visited the White House and toured the press conference room!</li>
